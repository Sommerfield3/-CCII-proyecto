...
public:
    ...
    void setupUi(QWidget *newmed)
    {
        ...
        newmed->resize(400, 550);
        QFont font;
        font.setPointSize(12);
        font.setBold(true);
        newmed->setFont(font);
        label_10 = new QLabel(newmed);
        label_10->setObjectName(QString::fromUtf8("label_10"));
        label_10->setGeometry(QRect(11, 11, 381, 41));
        label_10->setTextFormat(Qt::AutoText);
        label_10->setAlignment(Qt::AlignCenter);
        widget = new QWidget(newmed);
        widget->setObjectName(QString::fromUtf8("widget"));
        widget->setGeometry(QRect(11, 59, 381, 481));
        ...
        input_edad = new QSpinBox(widget);
