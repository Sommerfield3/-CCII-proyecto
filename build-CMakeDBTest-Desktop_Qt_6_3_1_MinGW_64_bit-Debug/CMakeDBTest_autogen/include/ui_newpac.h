...
public:
    ...
    void setupUi(QWidget *newpac)
    {
        ...
        newpac->resize(400, 400);
        QFont font;
        font.setPointSize(12);
        font.setBold(true);
        newpac->setFont(font);
        layoutWidget = new QWidget(newpac);
        layoutWidget->setObjectName(QString::fromUtf8("layoutWidget"));
        layoutWidget->setGeometry(QRect(10, 13, 381, 381));
        ...
        input_clave = new QLineEdit(layoutWidget);
        ...
        input_dir = new QLineEdit(layoutWidget);
        ...
        input_ciudad = new QLineEdit(layoutWidget);
        ...
        input_edad = new QSpinBox(layoutWidget);
        ...
        btn_volver = new QPushButton(layoutWidget);
